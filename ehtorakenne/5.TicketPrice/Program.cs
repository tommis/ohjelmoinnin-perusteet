...
namespace _5.TicketPrice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            acceptedDiscounts.Reverse();
            decimal biggestDiscount = (decimal)acceptedDiscounts[0];

            decimal ticketPrice = 16.0M - (16.0M * biggestDiscount);

            Console.WriteLine(string.Format("Price {0}e, accepted discount{1}%", ticketPrice, acceptedDiscounts[0]));
